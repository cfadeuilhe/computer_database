...
<body>
	...
	<jsp:useBean id="computerList" class="java.util.ArrayList"
		scope="application" />

	<section id="main">
		<div class="container">
			<h1 id="homeTitle">${completeList.size()}Computersfound</h1>
		...
		<div class="container" style="margin-top: 10px;">
			<table class="table table-striped table-bordered">
				...
				<tbody id="results">
					<c:forEach items="${computerList}" var="item" varStatus="i">
...
<page:pagination pageNumber="${page.pageNumber }" nbElementsPerPage="${page.nbElementsPerPage }" maxPageNumber="${page.last }" > </page:pagination>
